    ...
    <div className="flex flex-col items-center gap-4 py-8 px-5">
      ...
      <nav className="flex items-center gap-1" aria-label="Paginação">
        <button
          ...
          className={`bg-(${currentPage === 1 ? '--color-white-dust)' : `${colorTheme}) hover:text-(${colorTheme})`} w-9 h-9 flex items-center justify-center rounded-lg text-(--color-gray) fill-(--color-gray) transition-colors cursor-pointer disabled:cursor-default`}
        >
          <Image
            src={ArrowIcon.src}
            alt="Página anterior"
        ...
        <button
          ...
          className={`bg-(${currentPage === totalPages ? '--color-white-dust)' : `${colorTheme}) hover:text-(${colorTheme})`} w-9 h-9 flex items-center justify-center rounded-lg text-(--color-gray) fill-(--color-gray) transition-colors cursor-pointer disabled:cursor-default`}
        >
          <Image
            src={ArrowIcon.src}
            alt="Página anterior"
