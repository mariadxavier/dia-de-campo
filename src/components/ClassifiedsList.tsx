  ...
  return (
    <section className="flex flex-col w-full gap-4 md:gap-8 py-9 px-5 md:p-8">
      <div className="flex flex-col gap-1">
        <h1 className="font-bold text-2xl text-(--color-dark-blue)">Anúncios em destaque</h1>
      ...
      <div
        className={
          'rounded-lg w-fit p-2 mt-2 font-bold flex justify-center items-center bg-(--color-white-shell) text-(--color-dark-green) border border-(--color-light-gray)'
        }
